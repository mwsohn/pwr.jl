...
function plot(ht::pwr.htest)
    ...
    if ht.title in ("One-sample t-test power calculation",
        ...
        nmin = samplesizeTTest(d=d["d"],alpha = d["alpha"],power=0.8,sampletype=d["sampletype"],alternative=d["alternative"])
    ...
    elseif(ht.title == "T-test power calculation")
        ...
        nmin = d["n1"] + samplesizeT2nTest(d=d["d"],n1=d["n1"],alpha = d["alpha"],power=0.8,alternative=d["alternative"])
...
elseif ht.title == "Difference of proportion power calculation for binomial distribution (same sample)"
        ...
        nmin = samplesizeTwopTest( h=d["h"], alpha = d["alpha"], power = 0.8, alternative = d["alternative"])
...
elseif ht.title == "Difference of proportion power calculation for binomial distribution (different sample)"
        ...
        nmin = d["n1"] + samplesizeTwop2nTest(n1=d["n1"], h=d["h"], alpha = d["alpha"], power = 0.8, alternative = d["alternative"])
    ...
    elseif ht.title== "Balanced one-way analysis of variance power calculation"
        ...
        nmin = samplesizeAnovaTest(k=d["k"], f=d["f"], alpha = d["alpha"], power = 0.8)
    ...
    elseif ht.title == "Chi squared power calculation"
        ...
        nmin = samplesizeChisqTest(w=d["w"], alpha = d["alpha"], df=d["df"], power=0.8)
    ...
    elseif ht.title == "Mean power calculation for normal distribution with known variance"
        ...
        nmin = samplesizeNormTest(d=d["d"], alpha = d["alpha"], power = 0.8, alternative = d["alternative"])
    ...
    elseif ht.title == "Proportion power calculation for binomial distribution (arcsine transformation)"
        ...
        nmin = samplesizePTest(h=d["h"], alpha = d["alpha"], power = 0.8, alternative = d["alternative"])
    ...
    elseif ht.title == "Approximate correlation power calculation (arctangh transformation)"
        ...
        nmin = samplesizeRTest(r=d["r"], alpha = d["alpha"], power = 0.8, alternative = d["alternative"])
